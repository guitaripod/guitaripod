...
<a href="https://github.com/guitaripod/anvil/releases/tag/0.1.0">anvil</a> 0.1.0 [Swift] ⭐1 • A native iOS qBittorrent client. Pure programmatic UIKit, cross-compiled from Linux to iOS
<a href="https://github.com/guitaripod/unrager/releases/tag/0.17.5">unrager</a> 0.17.5 [Rust] ⭐4 • A calm Twitter/X TUI with a local-LLM rage filter
